                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post">
										<div class="form-group">
                                            ...
                                            <p class="help-block"><input class="form-control"  name="customer_name" id="customer_name" placeholder="Customer Name" required></p>
                                        </div>
					...
					<?php
						...
						if(isset($_POST['submit'])){
							...
							if(mysql_num_rows($sqls)>0){
								...
								echo "<script type='text/javascript'> alert('Already Added......!'); window.location.href = 'Add-Customer.php';</script>";
							}else{							

							$sql = "INSERT INTO customer (`customer_name`,`mobile_no`,`email_id`, `address`) VALUES ('$customer_name','$mobile_no','$email_id','$address')";

							mysql_query($sql);


							echo "<script type='text/javascript'> alert('SuccessFully Added......!'); window.location.href = 'Add-Customer.php';</script>";
							}
						}
