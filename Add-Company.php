                                ...
                                <div class="col-lg-6">
                                    <form role="form" method="post">
										<div class="form-group">
                                            ...
                                            <p class="help-block"><input class="form-control"  name="company_name" id="company_name" placeholder="Company Name" required></p>
                                        </div>
					...
					<?php
						...
						if(isset($_POST['submit'])){
							...
							if(mysql_num_rows($sqls)>0){
								...
								echo "<script type='text/javascript'> alert('Already Added......!'); window.location.href = 'Add_Company.php';</script>";
							}else{							

							$sql = "INSERT INTO company (`company_name`,`mobile_no`,`email_id`, `address`) VALUES ('$company_name','$mobile_no','$email_id','$address')";

							mysql_query($sql);


							echo "<script type='text/javascript'> alert('SuccessFully Added......!'); window.location.href = 'Add-Company.php';</script>";
							}
						}
