                        ...
                        <div class="panel-body">
                            <div class="dataTable_wrapper">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
									<?php 
										$sql = mysql_query("SELECT * FROM purchase p,company c WHERE c.company_id=p.company_id ORDER BY `p`.`purchase_id` DESC");
										while($res = mysql_fetch_array($sql)){
									?>
                                        <tr class="odd gradeX">
                                            <td><?php echo $res['purchase_id']; ?></td>
                                            <td><?php echo $res['company_bill_no']; ?></td>
                                            ...
                                            <td class="center"><a target="_blank()" href="view_purchase_bill.php?purchase_id=<?php echo $res['purchase_id']; ?>">View</a> <a target="_blank()" href="purchase_update.php?purchase_id=<?php echo $res['purchase_id']; ?>">Edit</a></td>
                                        </tr>
									<?php 
										}
									?>	
