<?php include('header.php'); ?>
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">View Date Wise Purchase</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <div class="table-responsive">
                                <table class="table">
									...
									<?php 
										...
										$sql = mysql_query("SELECT * FROM purchase p,company c WHERE c.company_id=p.company_id and entry_data>='$fdate' and entry_data<='$tdate' ORDER BY `p`.`purchase_id` DESC");
										$i=1;
