...
function populateCompanyId(bill_no){
 ...
 var xmlhttp;
        ...
        xmlhttp.open("GET","populate_payment_amount.php?bill_no="+bill_no,true);
        xmlhttp.send();	
}
</script>
<script>
...
function validateNumber(evt) {
        ...
        <div id="page-wrapper">
				...
				<input type="submit" name="submit" class="btn btn-primary" style="float: right;">
					...
					<?php
						...
						try{
							...
							$sqls = mysql_query("INSERT INTO purchase_payment (`purchase_id`,`payment_amount`,`remarks`,`entry_data`,payment_mode,cheque_no,cheque_date,bank_name,narration) VALUES ('$bill_no','$payment_amount','$remarks','$entry_data','$payment_mode','$cheque_no','$cheque_date','$bank_name','$narration')");
			...
			$sql="INSERT INTO transaction(date,amount,narration,fee_id,purchase_id) VALUES('$entry_data','$payment_amount','Purchase Payment','$bill_no','$bill_no')";
			$dbh->exec($sql);
			...
			$dbh->exec($sql);
						...
						?>
							<script type="text/javascript">
								window.location="Purchase-Payment.php";				
							</script>
