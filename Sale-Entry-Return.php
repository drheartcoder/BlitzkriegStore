...
function validateNumber(evt) {
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Billing Return Entry</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
			<div class="row">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" method="post">
										<div class="form-group">
                                            ...
                                            <p class="help-block"><input class="form-control"  name="sale_id" id="sale_id" onkeypress="return validateNumber(event)" placeholder="Enter Bill No" required></p>
                                        </div>
                                ...
                                <div class="col-lg-6">
									<div class="form-group">
                                            <label></label>
                                            <p class="help-block">	<input type="submit" name="submitreturn" class="btn btn-primary"></p>
                                        </div>
                ...
                <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
										...
										<div class="form-group">
                                            ...
                                            <p class="help-block"><?php echo $_POST['sale_id']; ?></p>
                                        </div>
										
                                        <div class="form-group">
                                            <label>Customer  Name*:</label>
											<input type="hidden" name="customer_id" value="<?php echo $result['customer_id']; ?>">
                                            <input class="form-control" name="customer_name" id="customer_name" placeholder="Customer Name" value="<?php echo $result['customer_name']; ?>" readonly required>
                                        </div>
                                        <div class="form-group">
                                            <label>Date*:</label>
                                ...
                                <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="mobile_no" id="mobile_no" maxlength="10" onchange="populateCustomerId(this.value)"   value="<?php echo $result['mobile_no']; ?>" readonly required>
                                        </div>
										<div class="form-group">
                                            <label>Email Id :</label>
                                            <input class="form-control" name="email_id" id="email_id" value="<?php echo $result['email_id']; ?>" readonly>
                                        </div>
										<div class="form-group">
                                            <label>Address:</label>
                                             <textarea class="form-control" rows="3" name="address" id="address" placeholder="Enter Address" readonly><?php echo $result['address']; ?></textarea>
                                        </div>
                    ...
                    <div class="panel panel-default">
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
                                        <tr>
                                            ...
                                            <td><input class="form-control" name="rate[]" id="<?php echo "rate".$i; ?>" readonly></td>
						...
						if(isset($_POST['submit'])){
							...
							$sql = mysqli_query($con,"INSERT INTO sale_return (sale_id,customer_id,tot_cash_amt,remark,entry_data) Values('$sale_id','$customer_id','$tot_cash_amt','$remark','$newDate')");
							
							$sale_return_id = mysqli_insert_id($con);
							
							$_SESSION['sale_return_id'] = $sale_return_id;
							...
							while($i<count($product_id)){
								...
								$sql = mysqli_query($con,"INSERT INTO sale_product_return (sale_return_id,product_id,quantity,price) Values('$sale_return_id','$product_id[$i]','$quantity[$i]','$rate[$i]')"); 
								echo "<br>";
							$i++;	
							}
						...
						?>
							<script type="text/javascript">
								window.location="Sale-Entry-Return.php";				
							</script>
...
<div class="feecont">
<?php 
	$sale_return_id = $_SESSION['sale_return_id'];
	$sql = mysqli_query($con,"SELECT * FROM sale_return s,customer c WHERE c.customer_id=s.customer_id and s.sale_return_id=$sale_return_id");
	$result = mysqli_fetch_array($sql);
?>
	</th>
</tr>
...
<?php 
	$sale_return_id = $_SESSION['sale_return_id'];
	$sql = mysqli_query($con,"SELECT p.product_name,sp.quantity,sp.price FROM sale_product_return sp,product p WHERE sp.product_id=p.product_id and sp.sale_return_id=$sale_return_id");
	$i=1;
	$totAmt = 0;
	while($res = mysqli_fetch_array($sql)){
?>
