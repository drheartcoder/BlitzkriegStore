                                    ...
                                    <form role="form" method="post">
                                        ...
                                        <div class="form-group">
											...
											<select name="user_type" id="user_type" class="form-control">
												...
												<option  <?php  if($res['user_type']=="Provider"){ echo "selected"; } ?> value="Provider">Provider</option>												
												<option  <?php  if($res['user_type']=="User"){ echo "selected"; } ?>  value="User">User</option>												
											</select>
                                        </div>
